...
public class LoadingProgressWheel extends View {
     ...
     * because this method is called after measuring the dimensions of MATCH_PARENT or WRAP_CONTENT.
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.LoadingProgressWheel_mn_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.LoadingProgressWheel_mn_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.LoadingProgressWheel_mn_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.LoadingProgressWheel_mn_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.LoadingProgressWheel_mn_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.LoadingProgressWheel_mn_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.LoadingProgressWheel_mn_barColor, barColor);

        rimColor = a.getColor(R.styleable.LoadingProgressWheel_mn_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.LoadingProgressWheel_mn_linearProgress, false);

        if (a.getBoolean(R.styleable.LoadingProgressWheel_mn_progressIndeterminate, false)) {
            spin();
        }
