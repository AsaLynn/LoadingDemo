...
public class LoadingBox {
    ...
    public static void showProgress(Context context, String msg, LoadingConfig dialogConfig) {
        try {
            dismissProgress();
            //设置配置
            if (dialogConfig == null) {
                dialogConfig = new LoadingConfig.Builder().build();
            }
    ...
    private static void configView(Context mContext) {
        if (mDialogConfig == null) {
            mDialogConfig = new LoadingConfig.Builder().build();
        }
        //设置动画
